...
# -*- coding: utf-8 -*-
"""
Created on Thu Mar 29 20:48:18 2018
...
# 字典開啟
def open_dict(DICT, path=r'./Dict/'):
...
mostdict = open_dict(DICT='most')#权重4，即在情感词前乘以3
verydict = open_dict(DICT='very')#权重3
moredict = open_dict(DICT='more')#权重2
ishdict = open_dict(DICT='ish')#权重0.5



def sentiment_score_list(dataset):
    seg_sentence = dataset.rstrip('。')
    seg_sentence = seg_sentence.split('。')
